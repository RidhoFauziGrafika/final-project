    ...
    <section class="py-5 text-break">
        <div class="container px-4 px-lg-5 mt-5">
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                @if ($fields->isEmpty())
                    <p class="text-center">Tidak ada lapangan</p>
                @endif
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-body-custom pt-3">
                                <div class="text-center">
                                    ...
                                    <!-- Product price-->
                                    <div class="rent-price mb-3 text-break">
                                        <span class="text-primary">{{ $field->harga }}/</span>Jam
                                    </div>
                                    <ul class="list-unstyled list-style-group text-break">
                            ...
                            <div class="card-footer border-top-0 bg-transparent">
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-info mt-auto text-white"
                                        href="{{ url('detail', $field->id) }}">Detail</a>
                                </div>
                            </div>
                        </div>
                    </div>
